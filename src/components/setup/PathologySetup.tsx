...
export default function PathologySetup() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const categoryData: PathologyCategory = {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold">Pathology Setup</h2>
          <p className="text-gray-600">Manage pathology test categories</p>
        </div>
        <div className="flex items-center space-x-4">
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>
                  {editingCategory ? 'Edit Pathology Category' : 'Add Pathology Category'}
                </DialogTitle>
              </DialogHeader>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Enter pathology category name"
                    required
                  />
                </div>
                <div>
          ...
          <Card>
            <CardContent className="text-center py-8">
              ...
              <p className="text-gray-500">
                {searchTerm ? 'No categories found matching your search.' : 'No pathology categories found.'}
              </p>
              {!searchTerm && (
                <Button
